...
- A revisabilidade exigida pela FR-021 é satisfeita por uma janela de revisão entre a preparação da versão e sua efetivação, não por aprovação manual obrigatória em toda release: a preparação pode ser mesclada automaticamente assim que as verificações de qualidade já exigidas (build, testes, cobertura) forem concluídas com sucesso, permanecendo cancelável por uma pessoa a qualquer momento antes disso. A alternativa — exigir clique manual em toda release — foi descartada por reintroduzir a dependência de uma ação humana lembrada a cada versão, que é exatamente o que esta feature busca eliminar do caminho feliz.
